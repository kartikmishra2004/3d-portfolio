...
export default function HeroSection() {
  return (
    <section className="min-h-[70vh] sm:min-h-screen flex flex-col overflow-y-visible relative" style={{ overflowX: 'clip' }}>
      <div className="flex flex-col flex-1 px-5 sm:px-8 md:px-12 max-w-[1920px] w-full mx-auto relative z-10 pointer-events-none pt-4 md:pt-32">
        <FadeIn delay={0.15} y={40} className="pt-20 md:pt-0 mt-8 sm:mt-6 md:-mt-2 lg:-mt-5 overflow-hidden">
          <h1
            ...
            style={{ fontSize: 'clamp(4.2rem, 16vw, 32rem)' }}
          >
            Hi i&apos;m
          </h1>
          <h1
        ...
        <div className="sm:flex-1 my-8 sm:my-0 min-h-[20px] sm:min-h-[60px]" />
